...
function useCreateContext(initialState) {
  function useContextData() {
    ...
    var subscribes = React.useRef(new Set());
...
var useDropdownContext = function useDropdownContext(selector) {
  var store = React.useContext(DropdownContext);
...
function List(_ref2) {
  ...
  var handleSearchTyping = React.useCallback(function (search, filteredOptions) {
...
function Button(_ref) {
  ...
  }, state.selected ? /*#__PURE__*/React__default.createElement(React.Fragment, null, (labels === null || labels === void 0 ? void 0 : labels.selectedPrefix) && /*#__PURE__*/React__default.createElement("span", {
...
function Wrapper(_ref) {
  ...
  var wrapperStatus = React.useRef({
  ...
  var memoizedDefault = React.useMemo(function () {
...
var Wrapper$1 = React.memo(Wrapper);
